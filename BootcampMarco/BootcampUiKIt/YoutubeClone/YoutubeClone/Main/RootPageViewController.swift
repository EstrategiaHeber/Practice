...
class RootPageViewController: UIPageViewController {
    ...
    // Propiedad que alcanera la cantidad de las vistas existentes
    var subViewControllers = [UIViewController]()
    
    // Propiedad que almacenara el numero de la vista en la que estamos parados
    var currentIndex: Int = 0
    
    // Delegado para MainViewController
